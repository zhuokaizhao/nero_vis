...
class Non_Eqv_Net(torch.nn.Module):
    def __init__(self, n_classes=10):
        super(Non_Eqv_Net, self).__init__()
        # convolution 1
...
# equivariant network
class Eqv_Net(torch.nn.Module):
    def __init__(self, num_rotation, n_classes=10):

        super(Eqv_Net, self).__init__()
