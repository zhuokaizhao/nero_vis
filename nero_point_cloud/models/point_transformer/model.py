...
class Backbone(nn.Module):
    def __init__(self, cfg):
        ...
        npoints, nblocks, nneighbor, n_c, d_points \
            = cfg.num_point, cfg.model.nblocks, cfg.model.nneighbor, cfg.num_class, cfg.input_dim
        # first mlp layer
        self.fc1 = nn.Sequential(
        ...
        for i in range(nblocks):
            ...
            self.transformers.append(
                TransformerBlock(channel, cfg.model.transformer_dim, nneighbor)
            )
...
# Point transformer network for segmentation, as shown in Figure 3, top
